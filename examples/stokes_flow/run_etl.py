...
"""Stokes Flow ETL pipeline runner.

This script handles component instantiation and runs the ETL orchestrator
for processing Stokes flow datasets.

Usage:
    python run_etl.py \\
        --config-name=stokes_etl \\
        etl.source.input_dir=/data/stokes-flow/train \\
        etl.sink.output_dir=/data/stokes-flow-curated/train
"""
...
def main(cfg: DictConfig) -> None:
    """Run the Stokes Flow ETL pipeline.
